...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { age: @beer.age, bio: @beer.bio, first_name: @beer.first_name, last_name: @beer.last_name }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { age: @beer.age, bio: @beer.bio, first_name: @beer.first_name, last_name: @beer.last_name }
    assert_redirected_to beer_path(assigns(:beer))
  end
